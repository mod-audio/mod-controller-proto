...
CMD_ARGS = {
	'ALL': {
		...
		'say': [],
		'l': [int,int,int,int,],
		'glcd_text': [int,int,int],
		'glcd_dialog': [],
		'glcd_draw': [int,int,int],
		'uc': [],
		'ud': [],
		'a': [int,int,int,int,],
		'd': [int,],
...
CMD_LOAD_PROFILE          = 'upr'
CMD_STORE_PROFILE         = 'ups'
CMD_DUO_BOOT              = 'boot'
...
CMD_DUOX_SAVE_SNAPSHOT    = 'ss'
CMD_DUOX_LOAD_SNAPSHOT    = 'sl'
CMD_DUOX_CLEAR_SNAPSHOT   = 'sc'
